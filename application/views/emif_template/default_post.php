...
<script>
    ...
    function get_comments(selector, parent_id, depth, post_id) {
        $.ajax({
            url: "<?= base_url('comments/get_ajax')?>/" + parent_id,
            method: "post",
            data: {
                depth: depth,
                post_id: post_id
    ...
    function reply_comment_submit(post_id) {
        $.ajax({
            url: "<?= base_url('comments/add/')?>/"+post_id,
            method: "post",
    ...
    function edit_comment(selector, comment_id) {
        $.ajax({
            url: "<?= base_url('comments/edit_ajax')?>",
            method: "post",
            data: {
    ...
    function edit_comment_submit(comment_id) {
        $.ajax({
            url: "<?= base_url('comments/edit')?>/"+comment_id,
            method: "post",
    ...
    function delete_comment(selector, comment_id, post_id) {
        ...
        if(r){
            $.ajax({
                url: "<?= base_url('comments/delete_ajax')?>/"+post_id,
                method: "post",
                data: {
                    comment_id: comment_id
                },
